...
public class CIT_130_week_2_main {
    ...
    public static void main(String[] args) {                
        ...
        if(FirstCounter.equals(SecondCounter))
        {
            FirstCounter.WriteEquals();
        }
        else
        {
            FirstCounter.WriteUnequal();
        }
        
        //Adding/subtracting around each object
